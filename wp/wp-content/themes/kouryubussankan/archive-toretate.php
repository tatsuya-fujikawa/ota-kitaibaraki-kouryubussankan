<?php get_header(); ?>
<div class="main-visual toretate">
    <div class="container container--main-visual">
        <h2><img src="<?php echo get_template_directory_uri(); ?>/assets/img/toretate/toretate-title.png" alt="お知らせ・イベント情報" class="main-visual__img"></h2>
    </div>
</div>


<section class="topics toretate">
    <div class="inner">
        <div class="detail">
            <?php if(have_posts()):
