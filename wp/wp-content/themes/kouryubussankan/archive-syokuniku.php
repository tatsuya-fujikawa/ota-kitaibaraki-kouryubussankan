...
<section class="lead syokuniku">
    <div class="inner">
        ...
        <figure>
            ...
            <figcaption>
                <p class="text font-size--L col-brown">肉の駅おおた店は、市場より直送の新鮮で「安心、安全」なお肉をみなさまに販売しております。</p>
...
<section id="topics" class="topics syokuniku">
    ...
    <div class="inner">
        ...
        <div class="category">
            <ul class="list flex">
                <li class="list__item font-size--LL"><a href="<?php echo home_url(); ?>/suisan/">水産</a></li>
